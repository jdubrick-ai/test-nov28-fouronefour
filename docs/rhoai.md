...
3) Access the `workbench` named `test-nov28-fouronefour-notebook`.
...
5) In the terminal, run `cd test-nov28-fouronefour` to navigate to your sample app's directory.
